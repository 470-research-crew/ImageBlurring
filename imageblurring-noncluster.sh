...
if [[ ! -d RAJA-build ]]; then
  git clone --recursive https://github.com/LLNL/RAJA.git && mkdir RAJA-build && mkdir RAJA-install
...
for i in {1..5}; do
    echo "Test $i"
    ../run-noncluster.sh ../wilson.jpg
done

echo 'Running program on wilson2.jpg'
for i in {1..5}; do
    echo "Test $i"
    ../run-noncluster.sh ../wilson2.jpg
done

echo 'Running program on duke_dog.jpg'
for i in {1..5}; do
    echo "Test $i"
    ../run-noncluster.sh ../duke_dog.jpg
done

echo 'Running program on duke_dog2.jpg'
for i in {1..5}; do
    echo "Test $i"
    ../run-noncluster.sh ../duke_dog2.jpg
done
