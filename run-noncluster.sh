...
if [ -e "raja" ]; then
    echo -n "RAJA:         "
    ./raja ${temp_file} output_raja.ppm ${width} ${height}
...
./dif_compare output_serial.png output_pthread.png
./dif_compare output_serial.png output_openmp.png
./dif_compare output_serial.png output_cuda.png
./dif_compare output_serial.png output_raja.png
